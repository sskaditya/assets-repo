...
urlpatterns = [
    ...
    path('reports/by-category/', views.report_by_category, name='report_by_category'),
    path('reports/by-location/', views.report_by_location, name='report_by_location'),
    path('reports/financial/', views.report_financial, name='report_financial'),
    path('reports/depreciation/', views.report_depreciation, name='report_depreciation'),
    path('reports/warranty/', views.report_warranty, name='report_warranty'),
    path('reports/amc/', views.report_amc, name='report_amc'),
    path('reports/maintenance/', views.report_maintenance, name='report_maintenance'),
    path('reports/assignment/', views.report_assignment, name='report_assignment'),
